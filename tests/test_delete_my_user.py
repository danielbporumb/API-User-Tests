...
class TestDeleteMyUser(unittest.TestCase):
    ...
    def test_delete_my_user_status_code(self):
        response = self.users_api.delete_my_user(self.my_user_id, self.access_token)
